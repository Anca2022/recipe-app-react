    ...
    return (
        <div className="home-page">
            ...
            <div className="search-bar">
                <input type="text" placeholder="enter a dish"></input>
            ...
            <div className="recipes">
                {
                    recipes.map((recipe) => <Link to={`/recipe-details/${recipe.id}`} state={recipe} key={recipe.id}><RecipeCard recipe={recipe}/></Link>)
                }
